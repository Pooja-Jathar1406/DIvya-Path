          ...
          <Container fluid>
            <div className="container ">
              ...
              <div className="container pb-5 text-center">
                ...
                workforce, but they often face greater challenges in finding and
                maintaining employment. In most cases, this is because they’re
                not given the opportunity to develop soft and hard job skills
                that characterize appealing candidates.
              </div>
            </div>
          </Container>
          <div className="container">
              ...
              <Col>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      This course is for the ones in customer care services who
                      want to learn about some of the calling dos and don'ts
                      they think are missing to polish their Tele calling
                      skills. All important professional lines for the calling
                      business are mentioned in this course.
                    </Card.Text>
                  </Card.Body>
                  <Card.Footer>
                    <button className="btn btn-primary">Enroll</button>
              ...
              <Col>
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      This is a great place to start your programming career or
                      hobby. This course is best for you,If you have never
