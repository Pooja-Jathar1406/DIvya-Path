...
export function JobAdmin(){
    return  (
        <>
          ...
          <title>Job_Admin</title>
          <div className="container">
            <br />
            <div className="card">
              <h5 className="card-header">JOB_PROFILE_02</h5>
              <div className="card-body">
                <h5 className="card-title">Hiring Person with Disability For Microsoft Power BI For PAN India</h5>
                ...
                <p>Strong analytical skills and the ability to pay careful attention to detail.
                ...
                <div className="btn-group row">
                  ...
                  <div className="dropdown col">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu2">
                      <li>
                        <button className="dropdown-item" type="button">Locomotor Disability</button>
                      </li>
                      <li>
                        <button className="dropdown-item" type="button">
                          Visual Impairment
                  ...
                  <div className="dropdown col">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu2">
                      <li>
                        <button className="dropdown-item" href="#">Active</button>
                      </li>
                      <li>
                        <button className="dropdown-item" href="#">In-Active</button>
                      </li>
                    </ul>
                  </div>
                </div>  
